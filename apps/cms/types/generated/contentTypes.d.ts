...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  info: {
    description: 'Scooter categories for filtering';
...
export interface ApiScooterScooter extends Schema.CollectionType {
  ...
  info: {
    description: 'Scutere 125cc pentru B125';
    displayName: 'Scooter';
    pluralName: 'scooters';
  ...
  attributes: {
    ...
    engine: Attribute.String & Attribute.Required;
    ...
    > &
      Attribute.Private;
    weight: Attribute.String & Attribute.Required;
  };
}
